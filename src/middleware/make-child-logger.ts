...
export function makeChildLogger(logger: winston.Logger, trace: string) {
  // A child object that inherits from the real Logger instance as the
  // prototype. Override the `write` function to inject the trace key.
  // FIXME: this depends on an unreleased version of winston.
