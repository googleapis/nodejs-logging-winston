...
| --------------------------- | --------------------------------- | ------ |
| Setup_explicit | [source code](https://github.com//blob/master/samples/setup_explicit.js) | [![Open in Cloud Shell][shell_img]](https://console.cloud.google.com/cloudshell/open?git_repo=https://github.com/&page=editor&open_in_editor=samples/setup_explicit.js,samples/README.md) |
